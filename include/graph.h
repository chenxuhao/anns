...
/*
  void load_parlay_graph(const char* gFile) {
    ...
    size_t write_block_size = 1000000;
    size_t index = 0;
    size_t total_size_read = 0;
    while(index < n){
      size_t g_floor = index;
      size_t g_ceiling = g_floor + write_block_size <= n ? g_floor + write_block_size : n;
  ...
  void save(char* oFile) {
    ...
    while(index < n){
      size_t floor = index;
      size_t ceiling = index+write_block_size <= n ? index+write_block_size : n;
